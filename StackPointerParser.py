...
def main():
    ...
    args_parser.add_argument('--char_num_filters', type=int, default=50, help='Number of filters in CNN(Character Level)')
    args_parser.add_argument('--eojul_num_filters', type=int, default=100, help='Number of filters in CNN(Eojul Level)')
    ...
    args_parser.add_argument('--word_dim', type=int, default=100, help='Dimension of Word embeddings')
    ...
    args_parser.add_argument('--pos_embedding', choices=['random', 'word2vec'], help='Embedding for part of speeches', required=True)
    args_parser.add_argument('--pos_path', help='path for part of speech embedding dict')
